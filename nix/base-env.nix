# Base environment shared between all machines including live ISO.
# Contains CLI tools, dev tools, haskell/nix tools, media CLI,
# fonts, theming, foot terminal, waybar, custom scripts.
#
# Heavy/desktop packages (KDE, blender, krita, gimp, libreoffice,
# steam, games, redundant browsers, etc.) stay in environment.nix.
