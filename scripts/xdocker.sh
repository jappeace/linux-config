...
# ib
#   docker run -d -v /tmp/.X11-unix:/tmp/.X11-unix -it ib bash 
#    docker exec -it c4609b22e96c   /root/Jts/tws
# complains about radoen si but doesn't matter, just needs some time to think
