...
values."
  ...
  (setq-default
   ...
   dotspacemacs-themes '(dracula monokai
                         spacemacs-dark
                         spacemacs-light
                         solarized-light
                         solarized-dark
   ...
   dotspacemacs-default-font '("inconsolata" ;; "Fira Code" ;;
                               :size 18
                               :weight normal
                               :width normal
                               :powerline-scale 1.1)
...
you should place your code here."
  (org-babel-load-file "~/.config/emacsconfig.org")
  )
