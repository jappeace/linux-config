...
* Font
** Fira code enabling
got it from [[https://github.com/tonsky/FiraCode/wiki/Setting-up-Emacs][here.]]
Its a fancy font that combines characters into better characters, ie
type -> and get a fancy arrow instead.
#+BEGIN_SRC emacs-lisp
(when (window-system)
