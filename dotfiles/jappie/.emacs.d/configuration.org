...
A font that can make special symbols of often occuring char combos,
such as a real arrow from ->
from [[https://github.com/tonsky/FiraCode/wiki/Setting-up-Emacs][here.]]
#+BEGIN_SRC emacs-lisp
;;; Fira code
